# Client Finder · Prospect Finding + First Message · Auto-Read Rule (AGENTS.md)
...
> The same rule lives in `CLAUDE.md` for Claude Code, and in `.cursor/rules/client-finder.mdc` for Cursor.
