# Ad Concept Factory · Auto-Read Rule
...
- NO made-up numbers, fake discounts, or non-existent guarantees. If your offer/number is not in `brand/01-brand.md`, leave a `[put your own number/offer here]` placeholder in the concept, never invent.
