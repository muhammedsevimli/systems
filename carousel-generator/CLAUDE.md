# Carousel + Hook Generator · Auto-Read Rule
...
> The same rule also lives in `AGENTS.md` (Codex, Google Antigravity, Windsurf and 20+ tools) and `.cursor/rules/carousel-generator.mdc` (Cursor).
