# Google Ads Auditor · Wasted Ad Spend + Fix List · Auto-Read Rule (AGENTS.md)
...
> For Claude Code the same rule is in `CLAUDE.md`, for Cursor in `.cursor/rules/google-ads-auditor.mdc`.
