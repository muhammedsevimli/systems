# Trend Radar · Rising Content Angles in Your Niche · Auto-Read Rule
...
- **Repeat threshold:** to call an angle a "trend" it must appear in at least 2 titles (or 1 Reddit + 1 pasted example). A single title goes to a separate section with an "maybe" note, not the main list of the brief.
